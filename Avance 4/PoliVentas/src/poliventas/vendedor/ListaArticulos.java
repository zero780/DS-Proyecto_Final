...
import poliventas.administrador.ModificarArticulo;
 ...
 * @author usuario
 */
public final class ListaArticulos extends javax.swing.JFrame {
    String tipoUsuario;
    Usuario usuario;
    Vendedor vendedor;
     ...
     * @param comprador
     */
    public ListaArticulos(Usuario usuario) {
        initComponents();
        this.usuario = usuario;
        jLabel4.setText(usuario.getNombres()+" "+usuario.getApellidos());
        
        jTable1.setVisible(false);
        tipoUsuario = "usuario";
        
    }
    public ListaArticulos(Vendedor vendedor) {
        initComponents();
    ...
    public String[] getColumnasE(){
        String columna[] = new String [] {"id","Vendedor","Producto","Precio"};
        return columna;
    }
    public void setFilas() throws SQLException{
        limpiartabla();
        
        ResultSet consulta= Singleton.Conexion.callProcedure("db_poliventas.listaArticulos('"+jTextField36.getText()+"','"+jTextArea1.getText()+"');");
    ...
    public void modificarArticulo(){
        ...
        if (filaseleccionada == -1){
            ...
            try {
                if(busqueda.next()){
                    if(vendedor==null){
                        ResultSet consulta = Conexion.callProcedure("db_poliventas.obtenerVendedor('"+busqueda.getString("vendedor")+"');");
                        consulta.next();
                        this.vendedor = Controladores.VendedorController.crearVendedor(consulta);
                    }
                    Articulo articulo = Controladores.ArticuloController.crearArticulo(busqueda, vendedor);
                    ModificarArticulo ma;
                    if (tipoUsuario.equals("usuario"))
                        ma = new ModificarArticulo(usuario, articulo,vendedor);
                    else
                        ma = new ModificarArticulo(vendedor, articulo);
                    ma.setVisible(true);
                ...
                Logger.getLogger(ListaArticulos.class.getName()).log(Level.SEVERE, null, ex);
            }
            Singleton.Conexion.cerrarConexion();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (tipoUsuario.equals("usuario")){
            MenuAdministrador ingreso = new MenuAdministrador(usuario);
